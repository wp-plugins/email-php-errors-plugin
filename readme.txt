...
The mail functionality can be utilized by entering a valid email address in the settings area of the plugin. A blank email will reault in no emails being sent. Be careful about setting the default error level to include all errors. There are a huge number of notices generated by plugins and themes and even the Wordpress core.
